...
return $this->services['App\Repository\TestRepository'] = new \App\Repository\TestRepository(${($_ = isset($this->services['doctrine']) ? $this->services['doctrine'] : $this->load('getDoctrineService.php')) && false ?: '_'});
